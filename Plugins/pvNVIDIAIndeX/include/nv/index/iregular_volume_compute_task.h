...
/// Interface class for a volume compute tasks operating on the voxel values of one regular volume
/// brick.
///
...
class IRegular_volume_compute_task : public mi::base::Interface_declare<0x5320df33, 0x4d84, 0x4ee1,
                                       0x9f, 0xab, 0x57, 0x67, 0xaa, 0xe8, 0x12, 0xc5>
{
public:
  ...
  ///
  virtual bool compute(const mi::math::Bbox_struct<mi::Uint32, 3>& brick_bbox,
    IRegular_volume_data* voxel_data, mi::neuraylib::IDice_transaction* dice_transaction) const = 0;
  ...
  virtual bool compute_gpu(const mi::math::Bbox_struct<mi::Uint32, 3>& brick_bbox,
    cudaArray* voxel_data, mi::neuraylib::IDice_transaction* dice_transaction) const = 0;
