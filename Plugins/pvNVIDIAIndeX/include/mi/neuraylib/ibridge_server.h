...
class IServer_job : public mi::base::Interface_declare<0x555dea0f, 0x4eeb, 0x44b9, 0xba, 0x81, 0x5a,
                      0x42, 0x3d, 0xe5, 0xf8, 0x30, neuraylib::ISerializable>
{
public:
...
template <Uint32 i_id1, Uint16 i_id2, Uint16 i_id3, Uint8 i_id4, Uint8 i_id5, Uint8 i_id6,
  Uint8 i_id7, Uint8 i_id8, Uint8 i_id9, Uint8 i_id10, Uint8 i_id11, class I = IServer_job>
class Server_job : public base::Interface_implement<I>
{
public:
  /// Own type.
  typedef Server_job<i_id1, i_id2, i_id3, i_id4, i_id5, i_id6, i_id7, i_id8, i_id9, i_id10, i_id11,
    I>
    Self;
...
class IServer_job_info : public mi::base::Interface_declare<0xa28b5525, 0x728b, 0x447a, 0x89, 0x9f,
                           0x15, 0x64, 0xdf, 0x14, 0xc7, 0xdc>
{
public:
...
class IServer_job_list : public mi::base::Interface_declare<0xde301678, 0x11e9, 0x4bed, 0x9b, 0xc3,
                           0x60, 0x1e, 0xcf, 0xa3, 0x88, 0xa9>
{
public:
...
class IServer_transaction_callback : public mi::base::Interface_declare<0x7796c406, 0xff8f, 0x423d,
                                       0x8f, 0x53, 0x1a, 0x66, 0x50, 0xcf, 0x83, 0x86>
{
public:
...
class IIncremental_snapshot_context : public mi::base::Interface_declare<0x5ec24e12, 0x9ce9, 0x4f39,
                                        0x9f, 0xd5, 0x35, 0xf1, 0xe5, 0x41, 0x34, 0x2e>
{
public:
...
class IServer_transaction : public mi::base::Interface_declare<0x67fd848e, 0xce43, 0x4675, 0x8b,
                              0x14, 0xb2, 0x54, 0xd, 0xd2, 0x29, 0x63>
{
public:
...
class IServer_session_state_callback : public mi::base::Interface_declare<0x12a50ba1, 0x9cfc,
                                         0x4a12, 0x9a, 0x4b, 0x52, 0x13, 0xf6, 0x98, 0x81, 0x11>
{
public:
...
class IServer_transaction_list : public mi::base::Interface_declare<0xe97c6925, 0x780, 0x40b7, 0x8c,
                                   0xc0, 0xa9, 0x2f, 0x73, 0xfe, 0xb7, 0x8>
{
public:
...
class IServer_session : public mi::base::Interface_declare<0x42574f4a, 0xfab1, 0x4fdc, 0xa0, 0xc7,
                          0x52, 0x48, 0xba, 0xfa, 0x8e, 0x7d>
{
public:
...
class IApplication_session_handler : public mi::base::Interface_declare<0x8913c078, 0xeba2, 0x4e0b,
                                       0x83, 0x44, 0x1, 0xcb, 0x2b, 0x57, 0x67, 0x3c>
{
public:
...
class IApplication : public mi::base::Interface_declare<0x84c2d806, 0x6e1f, 0x402d, 0xb2, 0xa, 0x2f,
                       0xcf, 0x47, 0xd1, 0xf, 0x2e>
{
public:
...
class IBridge_snapshot_context : public mi::base::Interface_declare<0x9a9ceafe, 0x876b, 0x4647,
                                   0xbc, 0xae, 0xb6, 0x4, 0x9c, 0x7b, 0x9, 0xfc>
{
public:
  ...
  virtual neuraylib::IImport_result* import_snapshot(neuraylib::ITransaction* transaction,
    const char* snapshot_id, const IMap* importer_options = 0) = 0;
...
class IBridge_server : public mi::base::Interface_declare<0x1fd8a3ac, 0xa70c, 0x4273, 0xa9, 0x1a,
                         0x67, 0x57, 0xdf, 0xc7, 0xa5, 0xb>
{
public:
