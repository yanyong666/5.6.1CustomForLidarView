...
class IScene_group : public mi::base::Interface_declare<0xdf29205a, 0x010c, 0x42c1, 0xbe, 0xc5,
                       0xb9, 0x5e, 0xcd, 0x3c, 0x76, 0x74, nv::index::IScene_element>
{
public:
  ...
  virtual bool append(mi::neuraylib::Tag_struct scene_element_tag,
  ...
  /// \param[in] dice_transaction  DiCE transaction
  /// \return true on success, or false when the element could not be added
  virtual bool prepend(mi::neuraylib::Tag_struct scene_element_tag,
    mi::neuraylib::IDice_transaction* dice_transaction) = 0;
  ...
  /// \param[in] dice_transaction  DiCE transaction
  /// \return true on success, or false when the element could not be added.
  virtual bool insert(mi::Uint32 index, mi::neuraylib::Tag_struct scene_element_tag,
    mi::neuraylib::IDice_transaction* dice_transaction) = 0;
  ...
  /// \param[in] dice_transaction  DiCE transaction
  /// \return true on success, or false when the element was not found
  virtual bool remove(mi::neuraylib::Tag_struct scene_element_tag,
    mi::neuraylib::IDice_transaction* dice_transaction) = 0;
...
class ITransformed_scene_group
  : public mi::base::Interface_declare<0xf6de2020, 0x3fcd, 0x4764, 0xb3, 0xbe, 0x3a, 0x07, 0xf0,
      0xee, 0xd6, 0x60, nv::index::IScene_group>
{
public:
...
class IStatic_scene_group : public mi::base::Interface_declare<0x11971a80, 0x8607, 0x4f8b, 0xa7,
                              0x77, 0x04, 0x42, 0x6a, 0xc2, 0xcc, 0xda, nv::index::IScene_group>
{
};
...
class IShape_scene_group
  : public mi::base::Interface_declare<0xab821bda, 0x0214, 0x4908, 0xbb, 0x51, 0xb4, 0xd6, 0x76,
      0x74, 0xb9, 0xb6, nv::index::ITransformed_scene_group>
{
public:
  ...
  /// \param[in] dice_transaction  DiCE transaction
  virtual void build(mi::neuraylib::Tag_struct manipulator_tag, const IScene* scene,
    mi::neuraylib::IDice_transaction* dice_transaction) = 0;
...
class IShape_scene_group_manipulator
  : public mi::base::Interface_declare<0x8ba83935, 0xb95b, 0x44ce, 0x83, 0x2a, 0x14, 0x06, 0x52,
      0x93, 0x45, 0x14, mi::neuraylib::IElement>
{
public:
  ...
  /// \param[in] scene             Scene object
  /// \param[in] dice_transaction  DiCE transaction
  virtual void build(IShape_scene_group* shape_group, const IScene* scene,
    mi::neuraylib::IDice_transaction* dice_transaction) = 0;
};
}
} // namespace index / nv
