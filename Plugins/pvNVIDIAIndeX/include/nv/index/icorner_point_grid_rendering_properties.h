...
class ICorner_point_grid_rendering_properties
  : public mi::base::Interface_declare<0x4df63b2c, 0x7e24, 0x4e16, 0xa9, 0x64, 0x2e, 0xbd, 0x41,
      0x9e, 0xc4, 0x51, nv::index::IAttribute>
{
public:
  ...
  /// Returns the sampling distance used for a corner-point grid scene element (\c
  /// ICorner_point_grid).
  virtual mi::Float32 get_sampling_distance() const = 0;

  /// Set the reference sampling distance used for a corner-point grid scene element (\c
  /// ICorner_point_grid).
  ...
  /// Returns the reference sampling distance used for a corner-point grid scene element (\c
  /// ICorner_point_grid).
  virtual mi::Float32 get_reference_sampling_distance() const = 0;

  /// Enable or disable pre-integrated volume rendering for a corner-point grid scene element (\c
  /// ICorner_point_grid).
