...
public:
  ...
  ///     if (t.is_valid()) ...
  ///   \endcode
  operator bool_conversion_support() const { return is_valid() ? &Tag::is_valid : 0; }
};
...
class ISerializable : public base::Interface_declare<0x7a70f2fb, 0x1b27, 0x416f, 0xaa, 0x21, 0x16,
                        0xc7, 0xb4, 0xd4, 0x1f, 0xfc>
{
public:
...
/// arithmetic.
class ISerializer : public base::Interface_declare<0xdcf5a659, 0x2b06, 0x436b, 0x82, 0x55, 0x36,
                      0x9d, 0xbd, 0xe7, 0x42, 0xb1>
{
public:
