...
///
class IDistributed_data : public mi::base::Interface_declare<0xe7159219, 0x4b05, 0x4201, 0x82, 0x70,
                            0x5a, 0xaf, 0xfc, 0x8b, 0xf4, 0xdb, nv::index::IScene_element>
{
public:
  ...
  {
    mi::math::Matrix_struct<mi::Float32, 4, 4> mat_struct =
      mi::math::Matrix<mi::Float32, 4, 4>(1.f);
    return mat_struct;
  };
