...
///
/// The interface class \c IHeightfield_interaction provides means for invoking a distributed
/// computing
...
class IDistributed_compute_algorithm
  : public mi::base::Interface_declare<0x5e67c454, 0x2566, 0x4485, 0xb3, 0xea, 0x76, 0x86, 0x5f,
      0x67, 0x45, 0xe6, mi::neuraylib::IFragmented_job>
{
public:
  ...
  ///
  virtual void get_updated_bounding_box(mi::math::Bbox_struct<mi::Float32, 3>& bbox) const = 0;
};
...
template <mi::Uint32 i_id1, mi::Uint16 i_id2, mi::Uint16 i_id3, mi::Uint8 i_id4, mi::Uint8 i_id5,
  ...
  mi::Uint8 i_id11, class I = IDistributed_compute_algorithm>
class Distributed_compute_algorithm : public mi::neuraylib::Fragmented_job<i_id1, i_id2, i_id3,
                                        i_id4, i_id5, i_id6, i_id7, i_id8, i_id9, i_id10, i_id11, I>
{
};
}
} // namespace index / nv
