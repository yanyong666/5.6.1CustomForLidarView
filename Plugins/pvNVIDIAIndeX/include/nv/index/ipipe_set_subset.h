...
class IPipe_subset_parameters : public mi::base::Interface_declare<0x3ee3429b, 0x0607, 0x4b87, 0xb3,
                                  0xe6, 0x9e, 0x94, 0x57, 0x60, 0x54, 0x41>
{
public:
  ...
  virtual bool set_property_coordinates(
    const mi::Float32* property_coordinates, mi::Size nb_property_coordinates) = 0;
  ...
  ///
  /// \param[in] coordinate_first         Domain-specific property coordinate value of the first
  /// vertex.
  /// \param[in] coordinate_last          Domain-specific property coordinate value of the last
  /// vertex.
  ///
  /// \return true on success, or false if one of the arguments is invalid.
  //
  virtual void set_property_coordinates_range(
    mi::Float32 coordinate_first, mi::Float32 coordinate_last) = 0;
  ...
  virtual void set_subset_status(
    mi::Float32 contains_start_point, mi::Float32 contains_end_point) = 0;
};

/// Distributed data storage for pipe sets.
class IPipe_set_subset : public mi::base::Interface_declare<0xea834969, 0x1c60, 0x4416, 0xbd, 0x05,
                           0x3a, 0x4b, 0xbe, 0x78, 0xef, 0x5f, IDistributed_data_subset>
{
public:
  ...
  virtual IPipe_subset_parameters* add_pipe(
    const mi::math::Vector_struct<mi::Float32, 3>* vertices, mi::Size nb_vertices) = 0;
  ...
  /// This should be used together with \c
  /// IPipe_subset_parameters::set_property_coordinates_range().
  ///
  /// \param[in] property_name       Unique name identifying the property.
  ...
  /// \return true on success, or false if one of the arguments is invalid.
  ///
  virtual bool set_property_data(const char* property_name, const mi::Float32* property_values,
    mi::Size nb_property_values, mi::Float32 coordinate_first = 0.f,
