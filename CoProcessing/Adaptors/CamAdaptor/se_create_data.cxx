...
extern "C" void se_create_grid_(int* ne, int* np, int* nlon, double* lonRad, int* nlat,
...
extern "C" void se_add_chunk_(int* nstep, int* chunkSize, double* lonRad, double* latRad,
...
extern "C" void se_catalyst_finalize_()
{
  se_finalize();
