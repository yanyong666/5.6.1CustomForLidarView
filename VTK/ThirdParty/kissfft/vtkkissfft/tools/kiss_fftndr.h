...
KISSFFTLIB_API kiss_fftndr_cfg  kiss_fftndr_alloc(const int *dims,int ndims,int inverse_fft,void*mem,size_t*lenmem);
/*
 dims[0] must be even
...
KISSFFTLIB_API void kiss_fftndr(
        kiss_fftndr_cfg cfg,
...
KISSFFTLIB_API void kiss_fftndri(
        kiss_fftndr_cfg cfg,
