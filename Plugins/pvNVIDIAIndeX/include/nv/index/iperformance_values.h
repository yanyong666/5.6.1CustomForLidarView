...
///
/// For each span, detailed information about the compositing time, the transferred image data
/// (memory), the
/// number of subcubes considered, etc. are gathered.
///
class IPer_span_statistics
  : public mi::base::Interface_declare<0x323be64a, 0xbd51, 0x4078, 0xb3, 0x29, 0xf6, 0xe8, 0x04,
      0x93, 0x70, 0xeb, mi::neuraylib::ISerializable>
{
public:
...
class IPerformance_values : public mi::base::Interface_declare<0xa3ed753a, 0x5a9c, 0x4157, 0xa4,
                              0x71, 0x52, 0x86, 0x5f, 0x5f, 0x43, 0xd9>
{
public:
