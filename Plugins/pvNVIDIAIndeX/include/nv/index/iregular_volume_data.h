...
///
class IRegular_volume_data : public mi::base::Interface_declare<0x85e9531b, 0x8469, 0x4441, 0xb2,
                               0xf, 0x4c, 0xb7, 0x91, 0xe0, 0x18, 0xb9>
{
public:
  /// Returns the bounding box of the volume data. The bounding box encloses the entire exposed
  /// data,
...
class IRegular_volume_data_typed
  : public mi::base::Interface_declare<0xaa57121c, 0xc289, 0x45c1, 0xb1, 0xce, 0x6c, 0x1e, 0x24,
      0x70, 0x57, 0x92, IRegular_volume_data>
{
public:
...
class IRegular_volume_data_uint8
  : public mi::base::Interface_declare<0x7381d9f7, 0xce08, 0x4d90, 0x8d, 0xe2, 0x0, 0x88, 0x9b, 0xb,
      0xe4, 0xc0, IRegular_volume_data_typed<mi::Uint8> >
{
};
...
class IRegular_volume_data_uint16
  : public mi::base::Interface_declare<0xd2f17224, 0xa8ef, 0x43a2, 0x9f, 0x40, 0x5c, 0x4c, 0xd,
      0xed, 0x57, 0xcb, IRegular_volume_data_typed<mi::Uint16> >
{
};
...
class IRegular_volume_data_float32
  : public mi::base::Interface_declare<0x626285ff, 0x4f80, 0x43ac, 0x85, 0x51, 0x7e, 0x73, 0x7f,
      0xd5, 0x9c, 0xb5, IRegular_volume_data_typed<mi::Float32> >
{
};
...
class IRegular_volume_data_rgba8
  : public mi::base::Interface_declare<0x3ecb4b7e, 0xc9c5, 0x476c, 0xa7, 0xf3, 0xed, 0x31, 0x4b,
      0x43, 0x1, 0x68, IRegular_volume_data_typed<mi::math::Vector_struct<mi::Uint8, 4> > >
{
};
