...
class IColormap : public mi::base::Interface_declare<0x68ba9632, 0xe3d6, 0x4ced, 0xa8, 0xd7, 0x32,
                    0x0f, 0x87, 0x33, 0xde, 0x1b, nv::index::IAttribute>
{
public:
  ...
  virtual void set_colormap(
    const mi::math::Color_struct* colormap_values, mi::Uint32 nb_entries) = 0;
