...
extern "C" void fv_create_grid_(int* dim, double* lonCoord, double* latCoord, double* levCoord,
  int* nCells2d, int* maxNcols, int* myRank)
{
...
extern "C" void fv_add_chunk_(int* nstep, int* chunkSize, double* lonRad, double* latRad,
...
extern "C" void fv_catalyst_finalize_()
{
  fv_finalize();
